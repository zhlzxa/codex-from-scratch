...
def test_a_crash_no_longer_leaks_the_session_lock(
    ...
    # Chapter 14: `--session-dir` moves the rollout, and nothing moves the
    # *recorder*, which defaults to `.minicodex/recordings` relative to the
    # working directory. This test has therefore been writing a real transcript
    # into the repository on every run since chapter 12, and it took a chapter
    # that goes looking at directories to notice.
