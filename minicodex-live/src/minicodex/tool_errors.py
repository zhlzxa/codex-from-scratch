...
Measured, not preferred: the same failed call sent back to two
...
the import cycle that `agent_types.py` exists to break. Same shape,
...
def permission_error(problem: str, *, you_sent: str | None = None, do_this: str) -> str:
    ...
    This exists because the two kinds of failure need opposite
    ...
    what was measured is in docs/history.md.
    """
