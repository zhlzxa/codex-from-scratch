...
class Agent:
    ...
    async def _respond(
        ...
        for attempt in range(self.retry_policy.attempts):
            ...
            # `attempt 5 of 4` before giving up (F15-03).  `wait_for`
            # deliberately does not check the count -- chapter 12 found that
            # check dead and deleted it, correctly: the loop is the one
            # enforcement point.  It just was not doing the enforcing.
